...
// Hooks into goToPage: when page 3 is shown, animates the score from 0 to the
// real value over 800ms with an ease-out cubic curve.

(function () {
  const _origGoToPage = goToPage;

  // Replace the global goToPage with a wrapper that fires the counter
  ...
  function animateScoreCounter() {
    ...
    // Read the real score that was already set by calculateAndShowResults
    ...
    // Reset display to 0 and add animation class
    el.textContent = '0';
